...
The manuscript contains six main figures and eight supplementary figures. Code-derived figures are stored under `reproduce/` with the same numbering used in the manuscript; final TIFF files are stored under `figures/`.
...
The final 600 dpi TIFF files are named `Figure_1.tiff`–`Figure_6.tiff` and `Supplementary_Figure_1.tiff`–`Supplementary_Figure_8.tiff`.
