"""Supplementary Figure 4e: nuclear-receptor pK regression."""
...
DATA = PACKAGE_ROOT / "supplementary_figure_4" / "data" / "panel_e_nr_pk_predictions.csv"
OUTPUT = PACKAGE_ROOT / "supplementary_figure_4" / "outputs" / "panels" / "supplementary_figure_4e"
def draw(fig, spec, label=""): return draw_family(fig, spec, DATA, "NR", label)
def main():
