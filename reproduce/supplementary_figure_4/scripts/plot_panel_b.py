"""Supplementary Figure 4b: ion-channel pK regression."""
...
DATA = PACKAGE_ROOT / "supplementary_figure_4" / "data" / "panel_b_ion_channel_pk_predictions.csv"
OUTPUT = PACKAGE_ROOT / "supplementary_figure_4" / "outputs" / "panels" / "supplementary_figure_4b"
def draw(fig, spec, label=""): return draw_family(fig, spec, DATA, "Ion channel", label)
def main():
