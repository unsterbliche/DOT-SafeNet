"""Supplementary Figure 4a: GPCR pK regression."""
...
DATA = PACKAGE_ROOT / "supplementary_figure_4" / "data" / "panel_a_gpcr_pk_predictions.csv"
OUTPUT = PACKAGE_ROOT / "supplementary_figure_4" / "outputs" / "panels" / "supplementary_figure_4a"
def draw(fig, spec, label=""): return draw_family(fig, spec, DATA, "GPCR", label)
def main():
