"""Supplementary Figure 4c: enzyme pK regression."""
...
DATA = PACKAGE_ROOT / "supplementary_figure_4" / "data" / "panel_c_enzyme_pk_predictions.csv"
OUTPUT = PACKAGE_ROOT / "supplementary_figure_4" / "outputs" / "panels" / "supplementary_figure_4c"
def draw(fig, spec, label=""): return draw_family(fig, spec, DATA, "Enzyme", label)
def main():
