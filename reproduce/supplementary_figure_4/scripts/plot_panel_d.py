"""Supplementary Figure 4d: kinase pK regression."""
...
DATA = PACKAGE_ROOT / "supplementary_figure_4" / "data" / "panel_d_kinases_pk_predictions.csv"
OUTPUT = PACKAGE_ROOT / "supplementary_figure_4" / "outputs" / "panels" / "supplementary_figure_4d"
def draw(fig, spec, label=""): return draw_family(fig, spec, DATA, "Kinase", label)
def main():
