...
def main(args):
    ...
    model_pretrain_cls_path = str(pathlib.Path(args.pretrained_checkpoint).expanduser().resolve())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained-checkpoint', required=True, help='OT-ProfileNet pretraining checkpoint')
