"""Supplementary Figure 3d: classification Matthews correlation coefficient."""
...
DATA = PACKAGE_ROOT / "supplementary_figure_3" / "data" / "panel_d_mcc_metrics.csv"
OUTPUT = PACKAGE_ROOT / "supplementary_figure_3" / "outputs" / "panels" / "supplementary_figure_3d"


def draw(ax, label="", show_legend=True):
    return draw_metric(ax, DATA, "MCC", "MCC", label, show_legend)
