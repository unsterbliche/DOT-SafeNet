"""Supplementary Figure 3b: classification AUROC."""
...
DATA = PACKAGE_ROOT / "supplementary_figure_3" / "data" / "panel_b_auroc_metrics.csv"
OUTPUT = PACKAGE_ROOT / "supplementary_figure_3" / "outputs" / "panels" / "supplementary_figure_3b"


def draw(ax, label="", show_legend=True):
    return draw_metric(ax, DATA, "AUROC", "AUROC", label, show_legend)
