...
order_table.to_csv(DATA / "supplementary_figure_7b_target_columns.csv", index=False)
mat.to_csv(DATA / "supplementary_figure_7b_evidence_matrix.csv")
...
for ext in ["png","pdf","svg"]:
    fig.savefig(OUT / f"supplementary_figure_7b_adr_target_association.{ext}", dpi=300, bbox_inches="tight")
plt.close(fig)
...
for ext in ["png","pdf","svg"]:
    legend.savefig(OUT / f"supplementary_figure_7b_adr_target_legend.{ext}", dpi=300, bbox_inches="tight")
plt.close(legend)